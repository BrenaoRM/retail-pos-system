const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Login-CosiCooE.js","assets/vendor-jF1s2-c6.js","assets/supabase-1T9tw6ve.js","assets/Login-CwkpzoRI.css","assets/Fechamento-BKcfiYjC.js","assets/format-CcxP-_eH.js","assets/Fechamento-D3XDOYQC.css","assets/Historico-CjnwArIW.js","assets/Historico-jpdBEvQk.css","assets/Plano-BJPMB1Y6.js","assets/Plano-XQq3oUCK.css","assets/Equipe-mwCvtFav.js","assets/Equipe-Cm_FHM0f.css","assets/RedefinirSenha-DXOo86PZ.js"])))=>i.map(i=>d[i]);
...
const Login = reactExports.lazy(() => __vitePreload(() => import('./Login-CosiCooE.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0));
const Fechamento = reactExports.lazy(() => __vitePreload(() => import('./Fechamento-BKcfiYjC.js'),true              ?__vite__mapDeps([4,1,5,2,6]):void 0));
const Historico = reactExports.lazy(() => __vitePreload(() => import('./Historico-CjnwArIW.js'),true              ?__vite__mapDeps([7,1,5,2,8]):void 0));
const Plano = reactExports.lazy(() => __vitePreload(() => import('./Plano-BJPMB1Y6.js'),true              ?__vite__mapDeps([9,1,2,10]):void 0));
const Equipe = reactExports.lazy(() => __vitePreload(() => import('./Equipe-mwCvtFav.js'),true              ?__vite__mapDeps([11,1,2,12]):void 0));
const RedefinirSenha = reactExports.lazy(() => __vitePreload(() => import('./RedefinirSenha-DXOo86PZ.js'),true              ?__vite__mapDeps([13,1,2,3]):void 0));
