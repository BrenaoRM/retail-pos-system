const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Login-TAF9Fekh.js","assets/vendor-jF1s2-c6.js","assets/supabase-1T9tw6ve.js","assets/Login-CwkpzoRI.css","assets/Fechamento-BUdozHKW.js","assets/format-CcxP-_eH.js","assets/Fechamento-BdxP_TxQ.css","assets/Historico-BApyuZdK.js","assets/Historico-jpdBEvQk.css","assets/Plano-KdFrn_tS.js","assets/Plano-XQq3oUCK.css","assets/Equipe-BcwA8LKJ.js","assets/Equipe-Cm_FHM0f.css","assets/RedefinirSenha-NPnon-HX.js"])))=>i.map(i=>d[i]);
...
const Login = reactExports.lazy(() => __vitePreload(() => import('./Login-TAF9Fekh.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0));
const Fechamento = reactExports.lazy(() => __vitePreload(() => import('./Fechamento-BUdozHKW.js'),true              ?__vite__mapDeps([4,1,5,2,6]):void 0));
const Historico = reactExports.lazy(() => __vitePreload(() => import('./Historico-BApyuZdK.js'),true              ?__vite__mapDeps([7,1,5,2,8]):void 0));
const Plano = reactExports.lazy(() => __vitePreload(() => import('./Plano-KdFrn_tS.js'),true              ?__vite__mapDeps([9,1,2,10]):void 0));
const Equipe = reactExports.lazy(() => __vitePreload(() => import('./Equipe-BcwA8LKJ.js'),true              ?__vite__mapDeps([11,1,2,12]):void 0));
const RedefinirSenha = reactExports.lazy(() => __vitePreload(() => import('./RedefinirSenha-NPnon-HX.js'),true              ?__vite__mapDeps([13,1,2,3]):void 0));
