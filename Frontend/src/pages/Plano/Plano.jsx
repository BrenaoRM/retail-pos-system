...
export default function Plano() {
      ...
      <div className="plano-root">
        <div className="plano-card">
          ...
          <p className="plano-sub">
            Sua assinatura está ativa e é renovada automaticamente todo mês.
          </p>
  ...
  // ── Plano cancelado mas ainda dentro do período ───────────
    ...
    return (
      <div className="plano-root">
        <div className="plano-card">
          ...
          <p className="plano-sub">
            Sua assinatura foi cancelada, mas você ainda tem acesso até o fim do período pago.
          </p>
          ...
          <button
            ...
            disabled={carregando}
            style={{ ...styles.btnPrimario, opacity: carregando ? 0.7 : 1 }}
          >
  ...
  return (
    <div className="plano-root">
      <div className="plano-card">
        ...
        <p className="plano-sub">
          Comece grátis por 30 dias. Depois, apenas
        </p>
        ...
        <p style={styles.rodape}>
          Cobrança automática mensal · Cancele quando quiser · Sem multa
        </p>
      </div>
    </div>
  );
...
const styles = {
  preco: {
    display: 'flex', alignItems: 'baseline', gap: 4, margin: '4px 0 8px',
  },
  precoValor: {
    fontSize: '2.2rem', fontWeight: 800, color: '#f1f5f9', letterSpacing: '-0.04em',
  },
  precoSufixo: {
  ...
  erro: {
    ...
    borderRadius: 8, padding: '8px 12px', width: '100%', margin: 0,
  },
  rodape: {
